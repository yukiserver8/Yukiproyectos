...
public:
	...
	int GetSkillFrustrum(int* SkillFrustrumX, int* SkillFrustrumY,BYTE angle,int x,int y,float tx,float ty);
	...
	int AddSkill(LPOBJ lpObj,int index);
