...
void InitReconnect()
{
	...
	SetCompleteHook(0xE8, 0x004BC0CF, &ReconnectMainProc); // Interface::Work()
}
...
void ReconnectDrawInterface()
{
	...
	RenderColor(240,88,160,20.0f);

	glColor3f(1.0f,0.0f,0.0f);
	RenderColor(241,101,((progress>158)?158:progress),6.0f);
	...
	DrawInterfaceText(320,91,gCustomMessage.GetMessage(26+ReconnectProgress));
