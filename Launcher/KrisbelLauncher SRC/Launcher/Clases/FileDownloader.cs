...
namespace Launcher.Clases
{
    class FileDownloader
    {
        ...
        public static void DownloadFile()
        {
            ...
            webClient.DownloadFileAsync(new Uri(Globals.ServerURL + "Update/" + Globals.OldFiles[curFile]), Globals.OldFiles[curFile]);
        }
        ...
        private static void webClient_DownloadProgressChanged(object sender, DownloadProgressChangedEventArgs e)
        {
            ...
            //(Linea de codigo original) Common.ChangeStatus("DOWNLOADFILE", Globals.OldFiles[curFile], Computer.ComputeDownloadSize(e.BytesReceived).ToString("0.00") + " MB ", Computer.ComputeDownloadSize(e.TotalBytesToReceive).ToString("0.00") + " MB");
